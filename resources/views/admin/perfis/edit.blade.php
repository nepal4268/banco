...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.perfis.update', $perfil->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descricao" class="form-control">{{ old('descricao', $perfil->descricao) }}</textarea>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissoes[]" value="{{ $perm->id }}" id="perm_{{ $perm->id }}" {{ $perfil->permissoes->contains($perm->id) ? 'checked' : '' }}>
